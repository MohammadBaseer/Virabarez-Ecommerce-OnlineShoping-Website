...
<title>ViraBarez | Category | E-commerce Marketplace</title>
...
if (@$_GET['items'] == 'Cosmetics')  
{
echo "<a href='ladies-fashion-cat' style='color: #C82333'>Ladies Fashion</a><span style='color: #C82333'>Cosmetics</span>";
// fetch data
// $Categorie =  "Cosmetics";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
...
// 
elseif (@$_GET['items'] == 'Watchs For Ladies') {
echo "<a href='ladies-fashion-cat' style='color: #C82333'>Ladies Fashion</a><span style='color: #C82333'>Watchs</span>";
// fetch data
// $Categorie =  "Watchs For Ladies";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
}
// 
elseif (@$_GET['items'] == 'Other Accessories for Ladies') {
echo "<a href='ladies-fashion-cat' style='color: #C82333'>Ladies Fashion</a><span style='color: #C82333'>Other Accessories</span>";
// fetch data
// $Categorie =  "Other Accessories for Ladies";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
}
// ------------------
elseif (@$_GET['items'] == 'Ladies Spring Clothing') {
echo "<a href='ladies-dress-cat' style='color: #C82333'>Ladies Clothing</a><span style='color: #C82333'>Ladies Spring Clothing</span>";
// fetch data
// $Categorie =  "Ladies Spring Clothing";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
}
// 
elseif (@$_GET['items'] == 'Ladies Summer Clothing') {
echo "<a href='ladies-dress-cat' style='color: #C82333'>Summer Clothing</a><span style='color: #C82333'>Ladies Summer Clothing</span>";
// fetch data
// $Categorie =  "Ladies Summer Clothing";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
}
// 
elseif (@$_GET['items'] == 'Ladies Winter Clothing') {
echo "<a href='ladies-dress-cat' style='color: #C82333'>Winter Clothing</a><span style='color: #C82333'>Ladies Winter Clothing</span>";
// fetch data
// $Categorie =  "Ladies Winter Clothing";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
}
// 
elseif (@$_GET['items'] == 'Ladies Other Clothing') {
echo "<a href='ladies-dress-cat' style='color: #C82333'>Other Clothing</a><span style='color: #C82333'>Ladies Other Clothing</span>";
// fetch data
// $Categorie =  "Ladies Other Clothing";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
}
...
// 
elseif (@$_GET['items'] == 'Ladies Shoes') {
echo "<a href='ladies-dress-cat' style='color: #C82333'>Shoes</a><span style='color: #C82333'>Ladies Shoes</span>";
// fetch data
// $Categorie =  "Ladies Shoes";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
}
//
elseif (@$_GET['items'] == 'Men Spring Clothing') {
echo "<a href='mens-dress-cat' style='color: #C82333'>Ladies Clothing</a><span style='color: #C82333'>Men Spring Clothing</span>";
// fetch data
// $Categorie =  "Men Spring Clothing";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
}
// 
elseif (@$_GET['items'] == 'Men Summer Clothing') {
echo "<a href='mens-dress-cat' style='color: #C82333'>Summer Clothing</a><span style='color: #C82333'>Men Summer Clothing</span>";
// fetch data
// $Categorie =  "abc";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
...
// 
elseif (@$_GET['items'] == 'Men Winter Clothing') {
echo "<a href='mens-dress-cat' style='color: #C82333'>Winter Clothing</a><span style='color: #C82333'>Men Winter Clothing</span>";
// fetch data
// $Categorie =  "Men Winter Clothing";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val']; 
$get =$_GET['items'];
}
// 
elseif (@$_GET['items'] == 'Men Other Clothing') {
echo "<a href='mens-dress-cat' style='color: #C82333'>Other Clothing</a><span style='color: #C82333'>Men Other Clothing</span>";
// fetch data
// $Categorie =  "Men Other Clothing";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
}
// 
elseif (@$_GET['items'] == 'Men Shoes') {
echo "<a href='mens-dress-cat' style='color: #C82333'>Shoes</a><span style='color: #C82333'>Men Shoes</span>";
// fetch data
// $Categorie =  "Men Shoes";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
...
// 
elseif (@$_GET['items'] == 'Men Watchs') {
echo "<a href='men-fashion-cat' style='color: #C82333'>Mens Fashion</a><span style='color: #C82333'>Men Watchs</span>";
// fetch data
// $Categorie =  "Men Watchs";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
}
elseif (@$_GET['items'] == 'Men Care') {
echo "<a href='men-fashion-cat' style='color: #C82333'>Mens Fashion</a><span style='color: #C82333'>Men Care</span>";
// fetch data
// $Categorie =  "Men Care";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
...
// 
elseif (@$_GET['items'] == 'Computer') {
echo "<a href='technology-cat' style='color: #C82333'>Technology</a><span style='color: #C82333'>Computer</span>";
// fetch data
// $Categorie =  "Computer";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
...
// 
elseif (@$_GET['items'] == 'Tablet') {
echo "<a href='technology-cat' style='color: #C82333'>Technology</a><span style='color: #C82333'>Tablet</span>";
// fetch data
// $Categorie =  "Tablet";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
...
elseif (@$_GET['items'] == 'Mobile') {
echo "<a href='technology-cat' style='color: #C82333'>Technology</a><span style='color: #C82333'>Mobile</span>";
// $Categorie =  "Mobile";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
}
elseif (@$_GET['items'] == 'Other Technology') {
echo "<a href='technology-cat' style='color: #C82333'>Technology</a><span style='color: #C82333'>Other Technology</span>";
// fetch data
// $Categorie =  "Other Technology";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
}
...
elseif (@$_GET['items'] == 'Diamond') {
echo "<a href='jeweller-cat' style='color: #C82333'>Jewelry</a><span style='color: #C82333'>Diamond</span>";
// fetch data
// $Categorie =  "Diamond";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
...
elseif (@$_GET['items'] == 'Gold') {
echo "<a href='jeweller-cat' style='color: #C82333'>Jewelry</a><span style='color: #C82333'>Gold</span>";
// fetch data
// $Categorie =  "Gold";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
...
elseif (@$_GET['items'] == 'Silver') {
echo "<a href='jeweller-cat' style='color: #C82333'>Jewelry</a><span style='color: #C82333'>Silver</span>";
// fetch data
// $Categorie =  "Silver";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
...
elseif (@$_GET['items'] == 'Other Jewelry') {
echo "<a href='jeweller-cat' style='color: #C82333'>Jewelry</a><span style='color: #C82333'>Other Jewelry</span>";
// fetch data
// $Categorie =  "Other Jeweller";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
$get =$_GET['items'];
}
// 
elseif (@$_GET['items'] == 'Electronics') {
echo "<a href='home-material-cat' style='color: #C82333'>Home Material</a><span style='color: #C82333'>Electronics</span>";
// fetch data
...
elseif (@$_GET['items'] == 'Furniturs') {
echo "<a href='home-material-cat' style='color: #C82333'>Home Material</a><span style='color: #C82333'>Furniturs</span>";
// fetch data
// $Categorie =  "Furniturs";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
...
elseif (@$_GET['items'] == 'Home Accessories') {
echo "<a href='home-material-cat' style='color: #C82333'>Home Material</a><span style='color: #C82333'>Home Accessories</span>";
// fetch data
...
// 
elseif (@$get['items'] == 'Watchs For Ladies') {
echo "<a href='ladies-fashion-cat' style='color: #C82333'>Ladies Fashion</a><span style='color: #C82333'>Watchs</span>";
// fetch data
// $Categorie =  "Watchs For Ladies";
// $_SESSION['val'] = $Categorie;
...
// 
elseif (@$get['items'] == 'Other Accessories for Ladies') {
echo "<a href='ladies-fashion-cat' style='color: #C82333'>Ladies Fashion</a><span style='color: #C82333'>Other Accessories</span>";
// fetch data
// $Categorie =  "Other Accessories for Ladies";
// $_SESSION['val'] = $Categorie;
...
// ------------------
elseif (@$get['items'] == 'Ladies Spring Clothing') {
echo "<a href='ladies-dress-cat' style='color: #C82333'>Ladies Clothing</a><span style='color: #C82333'>Ladies Spring Clothing</span>";
$get =$_GET['items'];

}
// 
elseif (@$get['items'] == 'Ladies Summer Clothing') {
echo "<a href='ladies-dress-cat' style='color: #C82333'>Summer Clothing</a><span style='color: #C82333'>Ladies Summer Clothing</span>";
// fetch data
// $Categorie =  "Ladies Summer Clothing";
// $_SESSION['val'] = $Categorie;
...
// 
elseif (@$get['items'] == 'Ladies Winter Clothing') {
echo "<a href='ladies-dress-cat' style='color: #C82333'>Winter Clothing</a><span style='color: #C82333'>Ladies Winter Clothing</span>";
// fetch data
// $Categorie =  "Ladies Winter Clothing";
// $_SESSION['val'] = $Categorie;
...
// 
elseif (@$get['items'] == 'Ladies Other Clothing') {
echo "<a href='ladies-dress-cat' style='color: #C82333'>Other Clothing</a><span style='color: #C82333'>Ladies Other Clothing</span>";
// fetch data
// $Categorie =  "Ladies Other Clothing";
// $_SESSION['val'] = $Categorie;
...
//
elseif (@$get['items'] == 'Men Spring Clothing') {
echo "<a href='mens-dress-cat' style='color: #C82333'>Ladies Clothing</a><span style='color: #C82333'>Men Spring Clothing</span>";
// fetch data
// $Categorie =  "Men Spring Clothing";
// $_SESSION['val'] = $Categorie;
...
// 
elseif (@$get['items'] == 'Men Summer Clothing') {
echo "<a href='mens-dress-cat' style='color: #C82333'>Summer Clothing</a><span style='color: #C82333'>Men Summer Clothing</span>";
// fetch data
// $Categorie =  "abc";
// $_SESSION['val'] = $Categorie;
...
// 
elseif (@$get['items'] == 'Men Winter Clothing') {
echo "<a href='mens-dress-cat' style='color: #C82333'>Winter Clothing</a><span style='color: #C82333'>Men Winter Clothing</span>";
// fetch data
// $Categorie =  "Men Winter Clothing";
// $_SESSION['val'] = $Categorie;
...
// 
elseif (@$get['items'] == 'Men Other Clothing') {
echo "<a href='mens-dress-cat' style='color: #C82333'>Other Clothing</a><span style='color: #C82333'>Men Other Clothing</span>";
// fetch data
// $Categorie =  "Men Other Clothing";
// $_SESSION['val'] = $Categorie;
...
elseif (@$get['items'] == 'Mobile') {
echo "<a href='technology-cat' style='color: #C82333'>Technology</a><span style='color: #C82333'>Mobile</span>";

$get =$_GET['items'];

}
elseif (@$get['items'] == 'Other Technology') {
echo "<a href='technology-cat' style='color: #C82333'>Technology</a><span style='color: #C82333'>Other Technology</span>";
// fetch data
// $Categorie =  "Mobile";
// $_SESSION['val'] = $Categorie;
...
elseif (@$get['items'] == 'Other Jeweller') {
echo "<a href='jeweller-cat' style='color: #C82333'>Jewelry</a><span style='color: #C82333'>Other Jeweller</span>";
// fetch data
// $Categorie =  "Other Jeweller";
// $_SESSION['val'] = $Categorie;
// $get = $_SESSION['val'];
...
elseif (@$get['items'] == 'Home Accessories') {
echo "<a href='home-material-cat' style='color: #C82333'>Home Material</a><span style='color: #C82333'>Home Accessories</span>";
// fetch data
// $Categorie =  "Home Accessories";
// $_SESSION['val'] = $Categorie;
...
// 
$c_query = mysqli_query($conn, "SELECT * FROM `product_table` Where product_status = 'Publish' AND seller_product_cat = '$get' ORDER BY product_id  DESC LIMIT $offset, $total_records_per_page");
