...
<title>Men's Clothing | E-commerce Marketplace</title>
...
<span style="color: #C82333">Men's Clothing</span>
</div>
</div>
</div>
</div>
 ...
 <div id="myCarousel" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/hero/m_clothing.jpg" alt="Los Angeles" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="img/hero/m_clothing1.jpg" alt="Chicago" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="img/hero/m_clothing2.jpg" alt="New York" width="1100" height="500">
    </div>
  </div>
...
<dir class="col-lg-6 col-md-6 col-sm-06 col-12">
	...
	<div class="col-md-8 col-lg-8 col-8">
		<h4 class="texth2" style="text-transform: uppercase; "><strong>Sring Cloths</strong></h4>
		<a href="category?items=Mens Spring Cloths" class="btn btn-danger" style="margin: 10px 0px;">VIEW PRODUCT</a>
	</div>
	<img class="col-md-4 col-lg-4 col-4" src="img/banner/m_spring.png" alt="" width="159px" style="float: right;: ">
</div>
</dir>
<!--  -->
<dir class="col-lg-6 col-md-6 col-sm-06 col-12">
	...
	<div class="col-md-8 col-lg-8 col-8">
		...
		<a href="category?items=Mens Summer Cloths" class="btn btn-danger" style="margin: 10px 0px;">VIEW PRODUCT</a>
	</div>
	<img class="col-md-4 col-lg-4 col-4" src="img/banner/m_summer.png" alt="" width="159px" style="float: right;: ">
</div>
</dir>
<!--  -->
<dir class="col-lg-6 col-md-6 col-sm-06 col-12">
	...
	<div class="col-md-8 col-lg-8 col-8">
		...
		<a href="category?items=Mens Winter Cloths" class="btn btn-danger" style="margin: 10px 0px;">VIEW PRODUCT</a>
	</div>
	<img class="col-md-4 col-lg-4 col-4" src="img/banner/m_winter.png" alt="" width="159px" style="float: right;: ">
</div>
</dir>
<!--  -->
<dir class="col-lg-6 col-md-6 col-sm-06 col-12">
  ...
  <div class="col-md-8 col-lg-8 col-8">
    ...
    <a href="category?items=Mens Other Cloths" class="btn btn-danger" style="margin: 10px 0px;">VIEW PRODUCT</a>
  </div>
  <img class="col-md-4 col-lg-4 col-4" src="img/banner/m_other.png" alt="" width="159px" style="float: right;: ">
</div>
</dir>
<!--  -->
<dir class="col-lg-6 col-md-6 col-sm-06 col-12">
  ...
  <div class="col-md-8 col-lg-8 col-8">
    ...
    <a href="category?items=Mens Shoes" class="btn btn-danger" style="margin: 10px 0px;">VIEW PRODUCT</a>
  </div>
  <img class="col-md-4 col-lg-4 col-4" src="img/banner/m_shoes.png" alt="" width="159px" style="float: right;: ">
</div>
</dir>
<!--  -->
</div>
