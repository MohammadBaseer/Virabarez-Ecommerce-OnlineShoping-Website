...
<title>Men's Fashion | E-commerce Marketplace</title>
...
<span style="color: #C82333">Men's Fashion</span>
</div>
</div>
</div>
</div>
 ...
 <div id="myCarousel" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/hero/m_style.jpg" alt="Los Angeles" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="img/hero/m_style1.jpg" alt="Chicago" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="img/hero/m_style2.jpg" alt="New York" width="1100" height="500">
    </div>
  </div>
...
<dir class="col-lg-6 col-md-6 col-sm-06 col-12">
	...
	<div class="col-md-8 col-lg-8 col-8">
		...
		<a href="category?items=Mens Watches" class="btn btn-danger" style="margin: 10px 0px;">VIEW PRODUCT</a>
	</div>
	<img class="col-md-4 col-lg-4 col-4" src="img/banner/m_watch.png" alt="" width="159px" style="float: right;: ">
</div>
</dir>
<!--  -->
<dir class="col-lg-6 col-md-6 col-sm-06 col-12">
	...
	align-items: center; height: 150px; background-color: #cfefea; border-radius: 10px;">
	<div class="col-md-8 col-lg-8 col-8">
		<h4 class="texth2" style="text-transform: uppercase; "><strong>Style</strong></h4>
		<a href="category?items=Mens Care" class="btn btn-danger" style="margin: 10px 0px;">VIEW PRODUCT</a>
	</div>
	<img class="col-md-4 col-lg-4 col-4" src="img/banner/man_fashion.png" alt="" width="159px" style="float: right;: ">
</div>
</dir>
<!--  -->
