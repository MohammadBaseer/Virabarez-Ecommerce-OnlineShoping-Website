...
<span class="pcoded-mtext">Settings</span>
 ...
 <!-- button -->
<a href="product_add" class="btn btn-danger" name="add">Add Product</a>
<!-- end -->
...
//"SELECT * FROM seller_profile_table left join seller_request_table on seller_request_table.seller_id = seller_profile_table.seller_req_id WHERE seller_profile_table.seller_user = '$user' ";   


$sql_sell = mysqli_query($conn, "SELECT * FROM product_table join seller_request_table ON seller_request_table.seller_id = product_table.product_seller_id WHERE seller_request_table.seller_id = $seller_req_id AND seller_request_table.seller_company_title = '$c_user' ORDER BY product_table.product_id DESC");
// 
                                 ?>
...
else
{
   echo "<label class='label label-danger'>".$row['stock_status']."</label>"; 
            ...
            <td>
                ...
                <a href="product_edit?e5HxuYol1Io8JLdit=<?php echo $row['product_id']; ?>&c5HxuYol1Io8JL_i=<?php echo $row['seller_company_title']; ?><?php echo "&token=ya29.5HxuYol1Io8JLeGePDznbfkkwu_PC4uodKwG8_1clFYAn9AgdOV1WGpOTNQP3s76HAsn7Y4zWw"; ?>">
                    <i class="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-green"></i>
                </a>

                <a href="includes/del_product?pro=<?php echo $row['product_id']; ?>" onClick="return confirm('are you sure you want to delete??');">
...
<div class="row"><h4><span style="width: 40%; font-weight: bold;">Date:&nbsp;&nbsp;</span><?php echo $row['product_entry_date']; ?></h4></div>
...
<a href="product_edit?e5HxuYol1Io8JLdit=<?php echo $row['product_id']; ?>&c5HxuYol1Io8JL_i=<?php echo $row['seller_company_title']; ?><?php echo "&token=ya29.5HxuYol1Io8JLeGePDznbfkkwu_PC4uodKwG8_1clFYAn9AgdOV1WGpOTNQP3s76HAsn7Y4zWw"; ?>" type="submit" class="btn btn-primary">Edit</a>
