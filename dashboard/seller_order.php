...
?>       
            ...
            <td style="text-align: left;"><?php echo $row['customer_name']; ?>
<?php 
if ($row['order_date'] == $date) {
?>
<span class="badge label label-success" style="float: right; background-color:#dc3545;">New</span>
<?php
}
 ?>
...
<?php if ($row['order_status'] == "Product Delivered"){ ?>
<td><span class="label label-success">Delivered</span> </td> 
<?php 
}
elseif ($row['order_status'] == "Canceled"){ ?>
<td><span class="label label-danger"><?php echo $row['order_status'];?></span> </td> 
<?php 
}else{ ?>
<td><span class="label label-info"><?php echo $row['order_status'];?></span></td>
<?php } ?>
            ...
            <td>
                ...
                <a href="seller_order_status?e5HxuYol1Io8JLdit=<?php echo $row['order_id']; ?>&c5HxuYol1Io8JL_i=<?php echo $row['product_name']; ?><?php echo "&token=ya29.5HxuYol1Io8JLeGePDznbfkkwu_PC4uodKwG8_1clFYAn9AgdOV1WGpOTNQP3s76HAsn7Y4zWw"; ?>">
