...
<br><br>
<div class="container">
<span class="btn btn-danger" style="background-color: #dc3545;" data-toggle="modal" data-target="#pass-update<?php echo $auth['seller_user']; ?>">Reset Password</span>
</div>
<!-- ===================================== -->
<div style="text-align: left;" class="modal fade" id="pass-update<?php echo $auth['seller_user']; ?>">
