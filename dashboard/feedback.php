                                ...
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Feedback Records</a> </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<tbody>
    <?php 
$i = 1;
$c_query = mysqli_query($conn, "SELECT * FROM msg_table ORDER BY msg_id DESC");
...
<td><?php echo $row['msg_whatsapp']; ?></td>
...
<!-- <a type="button" data-toggle="modal" data-target="#modal-edit<?php //echo $row1['newsletters_id']; ?>"> -->
    ...
    <a href="#" data-toggle="modal" data-target="#modal<?php echo $row['msg_id']; ?>">
...
<!-- =============== -->
<div style="text-align: left;" class="modal fade" id="modal<?php echo $row['msg_id']; ?>">
<div class="modal-dialog modal-lg">
<!-- moded for edid -->
<div class="modal-content">
<div class="modal-header">
<h4 class="modal-title"><?php echo $row['msg_name']; ?></h4>
...
<label class="mb-2 mr-sm-2">Category Type:</label>
<input class="form-control"  type="text" placeholder="Category Type" name="category_type" >
</div>
<div class="col-lg-12 col-md-12 mb-3">
<label class="mb-2 mr-sm-2">Category Relation to:</label>
<input class="form-control"  type="text" placeholder="Category Relation to" name="category_relation" >
</div>
</div>
