                             ...
                             <li class="user-profile header-notification">
                                 ...
                                 <div class="dropdown-primary dropdown">
                                     <div class="dropdown-toggle" data-toggle="dropdown">
                                         <img src="data_files/logo/<?php echo $auth['seller_logo']; ?>"
                             ...
                             <div class="row align-items-end">
                                 <div class="col-lg-8">
                                     <div class="page-header-title">
                                         ...
                                         <div class="d-inline">
                                             <h5>Products</h5>
                                             <span>Products of <?php echo $get_title; ?></span>
                                         </div>
                                     </div>
                                 </div>
                                 <div class="col-lg-4">
                                         ...
                                         <div class="row">
                                             ...
                                             <div class="col-md-12">
                                                 <div class="card table-card">
                                                     ...
                                                     <?php 
$c_query = mysqli_query($conn, "SELECT * FROM seller_request_table,seller_profile_table WHERE seller_request_table.seller_id = seller_profile_table.seller_req_id  AND seller_request_table.seller_id= '$get_id' AND  seller_request_table.seller_company_title = '$get_title' "); 
$row4 = mysqli_fetch_assoc($c_query);

$token_var = "ya29.5HxuYol1Io8JLeGePDznbfkkwu_PC4uodKwG8_1clFYAn9AgdOV1WGpOTNQP3s76HAsn7Y4zWw";
if ($get_token === $token_var AND $row4['seller_company_title'] == $get_title) 
{ 
 ?>
                                                                 ...
                                                                 <div class="form-group">
                                                                     ...
                                                                     <div class="row">
                                                                         <div class="col-lg-6 col-md-6 mb-3">
                                                                             <label class="mb-2 mr-sm-2">Product
                                                                                 Name:</label>
                                                                             <input class="form-control" type="text"
                                                                                 placeholder="Product Name"
                                                                                 name="product_name"
                                                                                 value="<?php if($var1 > $var2){echo $product_name;}?>"
                                                                                 <?php echo $style; ?>>
                                                                         </div>
                                                                         <!--  -->
                                                                         <div class="col-lg-6 col-md-6 mb-3">
                                                                             ...
                                                                             <input class="form-control" type="text"
                                                                                 ...
                                                                                 name="product_code"
                                                                                 value="<?php if($var1 > $var2){echo $product_code;}?>"
                                                                                 <?php echo $style;?>>
                                                                         </div>
                                                                         <!--  -->
                                                                         <div class="col-lg-6 col-md-6 mb-3">
                                                                             ...
                                                                             <input class="form-control" type="number"
                                                                                 min="0" placeholder="Price in AFN Only"
                                                                                 name="product_price"
                                                                                 value="<?php if($var1 > $var2){echo $product_price;}?>"
                                                                                 <?php echo $style;?>>
                                                                         </div>
                                                                         <!--  -->
                                                                         <div class="col-lg-6 col-md-6 mb-3">
                                                                             <label
                                                                                 class="mb-2 mr-sm-2">Discount:</label>
                                                                             <input class="form-control" type="number"
                                                                                 min="0" placeholder="Price in AFN Only"
                                                                                 name="product_discount"
                                                                                 value="<?php if($var1 > $var2){echo $product_discount;}?>"
                                                                                 <?php echo $style;?>>
                                                                         </div>
                                                                         <!--  -->
                                                                         <div class="col-lg-12 col-md-12 mb-3">
                                                                             <label class="mb-2 mr-sm-2">Free
                                                                                 Delivery:</label>
                                                                             <input class="form-control" type="text"
                                                                                 placeholder="Delivery (Kabul, Herat...)"
                                                                                 name="product_delivery"
                                                                                 value="<?php if($var1 > $var2){echo $product_delivery;}?>"
                                                                                 <?php echo $style;?>>
                                                                         </div>
                                                                         <!--  -->
                                                                         <!-- <div class="row"> -->
                                                                         <div class="col-sm-6 col-lg-6 m-b-30">
                                                                             <label class="mb-2 mr-sm-2">Select Stock
                                                                                 Status :</label>
                                                                             <select <?php echo $style;?>
                                                                                 name="stock_status"
                                                                                 class="custom-select">
                                                                                 <option value="In Stock">In Stock
                                                                                 </option>
                                                                                 <option value="Out Stock">Out Stock
                                                                                 </option>
                                                                             </select>
                                                                         </div>
                                                                         <!--  -->
                                                                         <div class="col-sm-6 col-lg-6 m-b-30">
                                                                             <label class="mb-2 mr-sm-2">Select Product
                                                                                 Categories :</label>
                                                                             <select <?php echo $style;?>
                                                                                 name="seller_product_cat"
                                                                                 class="custom-select">
...
?>
                                                                         ...
                                                                         <div class="col-lg-12 col-md-12 mb-3">
                                                                             ...
                                                                             <textarea id='editor1' class="form-control"
                                                                                 rows="5" type="text"
                                                                                 name="product_desc"
                                                                                 <?php echo $style;?>><?php if($var1 > $var2){echo $product_desc;}?></textarea>
                                                                         </div>
                                                                         <!--  -->
                                                                         <div class="col-lg-12 col-md-12 mb-3">
                                                                             <label class="mb-2 mr-sm-2">Product
                                                                             ...
                                                                             <textarea id='editor2' class="form-control"
                                                                                 rows="5" type="text"
                                                                                 name="product_info"
                                                                                 <?php echo $style;?>><?php if($var1 > $var2){echo $product_info;}?></textarea>
                                                                         </div>
                                                                 ...
                                                                 <div class="modal-footer justify-content-between">
                                                                     ...
                                                                     <button type="submit" class="btn btn-primary"
                                                                         name="add" value='Upload'>Create</button>
                                                                 </div>
                                                             </div>
                                                         </form>
                                                         <!-- </div> -->
    ...
    echo "<p style='margin:30px;'>wrong url. <a href='#' onclick='window.history.back()'>Back</a></p>";
}
