...
if ($get_token === $token_var AND $auth['seller_company_title'] == $get_title ) 
{
// ======
...
echo "<span class='label label-danger'>Order ".$row['order_status']." By Customer</span>";
}
else
{
 ?>
...
<a href="customer_order" class="btn btn-danger">Back</a>
</div>
<br>
<!-- ===================================================================================================================================================================================== -->
</div>
