...
$c_query = mysqli_query($conn, "SELECT * FROM seller_request_table");
...
<td><?php echo $row['seller_description']; ?></td>
...
<!-- <a type="button" data-toggle="modal" data-target="#modal-edit<?php //echo $row1['newsletters_id']; ?>"> -->
    ...
    <a href="create_seller_profile?id=<?php echo $row['seller_id']; ?>" type="button" title="Create User!" >
        <i class="icon feather icon-user f-w-600 f-16 m-r-15 text-c-green"></i>
    </a>
