...
<title>Technology | E-commerce Marketplace</title>
...
<span style="color: #C82333">Technology</span>
</div>
</div>
</div>
</div>
...
<dir class="col-lg-6 col-md-6 col-sm-06 col-12">
	...
	<div class="col-md-8 col-lg-8 col-8">
		<h4 class="texth2" style="text-transform: uppercase; "><strong>Computers</strong></h4>
		<a href="category?items=Computers" class="btn btn-danger" style="margin: 10px 0px;">VIEW PRODUCT</a>
	</div>
	<img class="col-md-4 col-lg-4 col-4" src="img/banner/t_pc.png" alt="" width="159px" style="float: right;: ">
</div>
</dir>
<!--  -->
<dir class="col-lg-6 col-md-6 col-sm-06 col-12">
	...
	align-items: center; height: 150px; background-color: #cfefea; border-radius: 10px;">
	<div class="col-md-8 col-lg-8 col-8">
		<h4 class="texth2" style="text-transform: uppercase; "><strong>Tablets</strong></h4>
		<a href="category?items=Tablets" class="btn btn-danger" style="margin: 10px 0px;">VIEW PRODUCT</a>
	</div>
	<img class="col-md-4 col-lg-4 col-4" src="img/banner/t_tablet.png" alt="" width="159px" style="float: right;: ">
</div>
</dir>
<!--  -->
<dir class="col-lg-6 col-md-6 col-sm-06 col-12">
	...
	align-items: center; height: 150px; background-color: #cfefea; border-radius: 10px;">
	<div class="col-md-8 col-lg-8 col-8">
		<h4 class="texth2" style="text-transform: uppercase; "><strong>Mobiles</strong></h4>
		<a href="category?items=Mobiles" class="btn btn-danger" style="margin: 10px 0px;">VIEW PRODUCT</a>
	</div>
	<img class="col-md-4 col-lg-4 col-4" src="img/banner/t_mobile.png" alt="" width="159px" style="float: right;: ">
</div>
</dir>
<!--  -->
<dir class="col-lg-6 col-md-6 col-sm-06 col-12">
  ...
  align-items: center; height: 150px; background-color: #cfefea; border-radius: 10px;">
  <div class="col-md-8 col-lg-8 col-8">
    <h4 class="texth2" style="text-transform: uppercase; "><strong>Other Technology</strong></h4>
    <a href="category?items=Other Technology" class="btn btn-danger" style="margin: 10px 0px;">VIEW PRODUCT</a>
  </div>
  <img class="col-md-4 col-lg-4 col-4" src="img/banner/t_other.png" alt="" width="159px" style="float: right;: ">
</div>
</dir>
<!--  -->
</div>
