...
<title>All Categories | E-commerce Marketplace</title>
...
<h3 style="color: #C82333"><strong>All Categories</strong></h3>
<div class="breadcrumb__option">
<a href="index" style="color: #C82333"></a>
</div>
</div>
</div>
</div>
...
<div class="container">
 ...
 <div class="row">
 	...
 	<div class="col-lg-3 col-md-3">
 		<h5 style="color: #C82333; cursor: pointer;" data-toggle="collapse" data-parent="#accordion" href="#collapse"><strong>Show All</strong></h5>
<!-- ============ -->
...
<a  data-toggle="collapse" data-parent="#accordion" href="#collapse" style="color: #f39393;">
<?php echo $rows_categories['category']; ?></a>
</strong>
</div>
...
<li class="ll"><a  href="category?items=<?php echo $rows_categories['subcategory']; ?>" class="aa"><?php echo $rows_categories['subcategory']; ?></a></li>
...
// 
 ...
 join seller_request_table on seller_request_table.seller_id = seller_profile_table.seller_req_id join product_table on seller_request_table.seller_id = product_table.product_seller_id WHERE  product_table.product_status = 'Publish' AND seller_profile_table.account_status = 'Enabled' ORDER BY product_id  DESC LIMIT $offset, $total_records_per_page");
