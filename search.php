...
<title>Search | E-commerce Marketplace</title>
...
<h3 style="color: #C82333"><strong>Search Result</strong></h3>
...
// echo "<script>alert('".$_POST['term']."')</script>";
$se = $_SESSION['term'] = $_POST['term'];
// echo $se;
}
 ?>
...
if (@$term = mysqli_real_escape_string($conn,$_REQUEST['term'])) {
 $se = $_SESSION['term'] = $term ;
  // $_SESSION['term'] = $_REQUEST['term'];
...
<!-- ================== -->
          ...
          <section>
            ...
            <div class="row d-flex justify-content-around align-items-center mb-4">
              ...
              <div class="col-6 col-md-4 text-md-left mt-3" >
<div class="filter__option" style="float: left;">
...
$c_query = mysqli_query($conn, "SELECT * FROM seller_profile_table 
 join seller_request_table on seller_request_table.seller_id = seller_profile_table.seller_req_id join product_table on seller_request_table.seller_id = product_table.product_seller_id WHERE  product_table.product_status = 'Publish' AND seller_profile_table.account_status = 'Enabled' AND product_name LIKE '%".$term."%' OR product_code LIKE '%".$term."%' ORDER BY product_id  DESC LIMIT $offset, $total_records_per_page");
...
<a href="" onclick="delete_data(event,<?php echo $row['product_id'];?>,<?php echo $c; ?>)">
  ...
  <span class="fa fa-heart wish" style="color: #dc3545;"></span></span>
<?php
}
}
else
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Order:<?php echo $row['product_name']; ?>
</h4>
...
<!-- <button class="btn btn-danger btn-sm waves-effect text-center m-b-20 iinntt" style="color:#fff;display: flex;" onclick="order_now(event,<?php //echo $c; ?>,<?php //echo $row['product_id']; ?>,$('.o_shipp_add').val(),$('.o_shipp_country').val(),$('.o_shipp_city').val(),$('.o_ship_phone').val(),$('.o_ship_qty').val())" data-dismiss="modal">Order Now</button> -->
...
// this function is used to: submit php form and refresh pop will hide
